...
<section class="student-marks-add-new p-3">
  ...
  <div class="d-flex justify-content-end m-4">
    <button class="btn btn-warning"> <a href="/student-report-above-fifth" class="text-light"> Student-report </a> </button>
  </div>

  <form action=" {{ route('student-marks-above-fifth.store') }} " method="POST" enctype="multipart/form-data">
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr> 
              ...
              <td colspan="1"> History & Civics </td>

              <td colspan="1"> <input type=" text " name="history_civics_unit_I_marks" class="form-control " id="social_studies_unit_I_marks_id" style="width: 120px;margin: auto;"></td>


              <td> <input type="number" name="history_civics_I_term_assesment_marks" class="form-control" id="social_studies_I_term_assesment_marks_id"></td>

              <td> <input type="number" name="history_civics_I_term_exam_marks" class="form-control" id="social_studies_I_term_exam_marks_id"></td>

              <td> <input type=" text " name="history_civics_I_term_total_marks" class="form-control" id="social_studies_I_term_total_marks_id"></td>

              <td> <input type=" text " name="history_civics_I_term_grade" class="form-control" id="history_civics_I_term_grade_id"></td>


              <td> <input type="number" name="history_civics_II_term_assesment_marks" class="form-control" id="social_studies_II_term_assesment_marks_id"></td>

              <td> <input type="number" name="history_civics_II_term_exam_marks" class="form-control" id="social_studies_II_term_exam_marks_id"></td>

              <td> <input type=" text " name="history_civics_II_term_total_marks" class="form-control" id="social_studies_II_term_total_marks_id"></td>

              <td> <input type=" text " name="history_civics_II_term_grade" class="form-control" id="history_civics_II_term_grade_id"></td>

              <td> <input type="number" name="history_civics_III_term_assesment_marks" class="form-control" id="social_studies_III_term_assesment_marks_id"></td>

              <td> <input type="number" name="history_civics_III_term_exam_marks" class="form-control" id="social_studies_III_term_exam_marks_id"></td>

              <td> <input type=" text " name="history_civics_III_term_total_marks" class="form-control" id="social_studies_III_term_total_marks_id"></td>

              <td> <input type=" text " name="history_civics_III_term_grade" class="form-control" id="history_civics_III_term_grade_id"></td>
            ...
            <tr> 
              ...
              <td colspan="1"> Geography </td>

              <td colspan="1"> <input type=" text " name="geography_unit_I_marks" class="form-control " id="social_studies_unit_I_marks_id" style="width: 120px;margin: auto;"></td>


              <td> <input type="number" name="geography_I_term_assesment_marks" class="form-control" id="social_studies_I_term_assesment_marks_id"></td>

              <td> <input type="number" name="geography_I_term_exam_marks" class="form-control" id="social_studies_I_term_exam_marks_id"></td>

              <td> <input type=" text " name="geography_I_term_total_marks" class="form-control" id="social_studies_I_term_total_marks_id"></td>

              <td> <input type=" text " name="geography_I_term_grade" class="form-control" id="geography_I_term_grade_id"></td>


              <td> <input type="number" name="geography_II_term_assesment_marks" class="form-control" id="social_studies_II_term_assesment_marks_id"></td>

              <td> <input type="number" name="geography_II_term_exam_marks" class="form-control" id="social_studies_II_term_exam_marks_id"></td>

              <td> <input type=" text " name="geography_II_term_total_marks" class="form-control" id="social_studies_II_term_total_marks_id"></td>

              <td> <input type=" text " name="geography_II_term_grade" class="form-control" id="geography_II_term_grade_id"></td>


              <td> <input type="number" name="geography_III_term_assesment_marks" class="form-control" id="social_studies_III_term_assesment_marks_id"></td>

              <td> <input type="number" name="geography_III_term_exam_marks" class="form-control" id="social_studies_III_term_exam_marks_id"></td>

              <td> <input type=" text " name="geography_III_term_total_marks" class="form-control" id="social_studies_III_term_total_marks_id"></td>

              <td> <input type=" text " name="geography_III_term_grade" class="form-control" id="geography_III_term_grade_id"></td>
            ...
            <tr> 
              ...
              <td colspan="1"> <input type=" text " name="physics_unit_I_marks" class="form-control " id="math_unit_I_marks_id" style="width: 120px;margin: auto;"></td>


              <td> <input type="number" name="physics_I_term_assesment_marks" class="form-control" id="math_I_term_assesment_marks_id"></td>

              <td> <input type="number" name="physics_I_term_exam_marks" class="form-control" id="math_I_term_exam_marks_id"></td>

              <td> <input type=" text " name="physics_I_term_total_marks" class="form-control" id="math_I_term_total_marks_id"></td>


              <td> <input type=" text " name="physics_I_term_grade" class="form-control" id="physics_I_term_grade_id"></td>


              <td> <input type="number" name="physics_II_term_assesment_marks" class="form-control" id="math_II_term_assesment_marks_id"></td>

              <td> <input type="number" name="physics_II_term_exam_marks" class="form-control" id="math_II_term_exam_marks_id"></td>

              <td> <input type=" text " name="physics_II_term_total_marks" class="form-control" id="math_II_term_total_marks_id"></td>

              <td> <input type=" text " name="physics_II_term_grade" class="form-control"id="physics_II_term_grade_id"></td>


              <td> <input type="number" name="physics_III_term_assesment_marks" class="form-control" id="math_III_term_assesment_marks_id"></td>

              <td> <input type="number" name="physics_III_term_exam_marks" class="form-control" id="math_III_term_exam_marks_id"></td>

              <td> <input type=" text " name="physics_III_term_total_marks" class="form-control" id="math_III_term_total_marks_id"></td>


              <td> <input type=" text " name="physics_III_term_grade" class="form-control" id="physics_III_term_grade_id"></td>
            ...
            <tr> 
              ...
              <td colspan="1"> <input type=" text " name="chemistry_unit_I_marks" class="form-control " id="math_unit_I_marks_id" style="width: 120px;margin: auto;"></td>


              <td> <input type="number" name="chemistry_I_term_assesment_marks" class="form-control" id="math_I_term_assesment_marks_id"></td>

              <td> <input type="number" name="chemistry_I_term_exam_marks" class="form-control" id="math_I_term_exam_marks_id"></td>

              <td> <input type=" text " name="chemistry_I_term_total_marks" class="form-control" id="math_I_term_total_marks_id"></td>

              <td> <input type=" text " name="chemistry_I_term_grade" class="form-control" id="chemistry_I_term_grade_id"></td>


              <td> <input type="number" name="chemistry_II_term_assesment_marks" class="form-control" id="math_II_term_assesment_marks_id"></td>

              <td> <input type="number" name="chemistry_II_term_exam_marks" class="form-control" id="math_II_term_exam_marks_id"></td>

              <td> <input type=" text " name="chemistry_II_term_total_marks" class="form-control" id="math_II_term_total_marks_id"></td>


              <td> <input type=" text " name="chemistry_II_term_grade" class="form-control" id="chemistry_II_term_grade_id"></td>


              <td> <input type="number" name="chemistry_III_term_assesment_marks" class="form-control" id="math_III_term_assesment_marks_id"></td>

              <td> <input type="number" name="chemistry_III_term_exam_marks" class="form-control" id="math_III_term_exam_marks_id"></td>

              <td> <input type=" text " name="chemistry_III_term_total_marks" class="form-control" id="math_III_term_total_marks_id"></td>


              <td> <input type=" text " name="chemistry_III_term_grade" class="form-control" id="chemistry_III_term_grade_id"></td>
            ...
            <tr> 
              ...
              <td colspan="1"> Biology </td>

              <td colspan="1"> <input type=" text " name="biology_unit_I_marks" class="form-control " id="math_unit_I_marks_id" style="width: 120px;margin: auto;"></td>


              <td> <input type="number" name="biology_I_term_assesment_marks" class="form-control" id="math_I_term_assesment_marks_id"></td>

              <td> <input type="number" name="biology_I_term_exam_marks" class="form-control" id="math_I_term_exam_marks_id"></td>

              <td> <input type=" text " name="biology_I_term_total_marks" class="form-control" id="math_I_term_total_marks_id"></td>


              <td> <input type=" text " name="biology_I_term_grade" class="form-control" id="biology_I_term_grade_id"></td>


              <td> <input type="number" name="biology_II_term_assesment_marks" class="form-control" id="math_II_term_assesment_marks_id"></td>

              <td> <input type="number" name="biology_II_term_exam_marks" class="form-control" id="math_II_term_exam_marks_id"></td>

              <td> <input type=" text " name="biology_II_term_total_marks" class="form-control" id="math_II_term_total_marks_id"></td>

              <td> <input type=" text " name="biology_II_term_grade" class="form-control"id="biology_II_term_grade_id"></td>


              <td> <input type="number" name="biology_III_term_assesment_marks" class="form-control" id="math_III_term_assesment_marks_id"></td>

              <td> <input type="number" name="biology_III_term_exam_marks" class="form-control" id="math_III_term_exam_marks_id"></td>

              <td> <input type=" text " name="biology_III_term_total_marks" class="form-control" id="math_III_term_total_marks_id"></td>

              <td> <input type=" text " name="biology_III_term_grade" class="form-control" id="biology_III_term_grade_id"></td>
